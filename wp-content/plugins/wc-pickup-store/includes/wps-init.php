		...
		public function init_form_fields() {
			$this->form_fields = array(
				...
				'external_bootstrap' => array(
					...
					'default'  => 'no',
					'description' => __( 'Disable external Bootstrap library. Current version 3.3.7.', 'wc-pickup-store' ),
					'desc_tip'    => true
				),
				'external_font_awesome' => array(
					...
					'label' => __( 'Disable', 'woocommerce' ),
					'default'  => 'no',
					'description' => __( 'Disable external Font Awesome library. Current version 4.7.0.', 'wc-pickup-store' ),
					'desc_tip'    => true
				),
				'local_css' => array(
					...
					'label' => __( 'Disable', 'woocommerce' ),
					'default'  => 'no',
					'description' => __( 'Disable local css library.', 'wc-pickup-store' ),
					'desc_tip'    => true
				),
