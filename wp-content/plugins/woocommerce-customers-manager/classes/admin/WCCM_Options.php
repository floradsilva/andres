	...
	private function render_options_page()
	{
		...
		<div class="wrap">
			...
			<div id="options-container">
				...
				<p>
					<label><?php _e('Hide guest customers who have not purchased anything (Customers who has only cancelled and/or refunded orders)', 'woocommerce-customers-manager');?></label>
