...
public function get_vat_number($user_id)
{
 ...
 public function bulk_switch_roles($roles_array)
 {
  ...
  //Moved
  public function get_user_total_spent($starting_date = null, $ending_date = null, $orders = array(),  $currency_symbol = true, $include_refunds = false)
	{
		...
		if($include_refunds)
		{
			$query_addons['statuses'][] = 'wc-refunded';
		}
		$query_string = "  SELECT SUM(meta.meta_value) AS total_sales, COUNT(posts.ID) AS total_orders 
								...
								AND posts.post_status IN ('" . implode( "','", $query_addons['statuses'])."') "
