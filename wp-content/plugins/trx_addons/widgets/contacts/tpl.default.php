...
if (!empty($description)) {
	?><div class="contacts_description"><?php trx_addons_show_layout( wpautop($description) ); ?></div><?php
}
	...
	if (!empty($address) || !empty($phone) || !empty($email)) {
		?><div class="contacts_info"><?php
			...
			if (!empty($phone) || !empty($email)) {
				...
				if (!empty($phone)) {
					?><span class="contacts_phone"><a href="tel:<?php echo esc_url($phone); ?>"><?php echo trim($phone); ?></a></span><?php
				}
				?></div><?php
			}
		?></div><?php
