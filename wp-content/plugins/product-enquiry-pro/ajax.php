 ...
 * When admin sends a reply on any quote from customer , on send button click this function is called through ajax.
 * In the enquiry Thread table, put the details of reply sent by admin.
