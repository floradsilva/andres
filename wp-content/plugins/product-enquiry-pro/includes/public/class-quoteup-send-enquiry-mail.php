...
class SendEnquiryMail extends \WC_Email
{
    ...
    */
    public function trigger()
    {
        ...
        // Send Email to authors if multi-product enquiry is enabled and
  ...
  /**
    ...
    */
    ...
    function sendEmailtoAuthorsForProducts($subject, $headers, $attachments)
    {
        ...
        // Check if multi-product enquiry is enabled.
        ...
        if (quoteupAreAuthorEmailsSame($authorEmails)) {
            return;
        }
    ...
    {
        if (isset($email_data[ 'send_mail_to_author' ]) && $email_data[ 'send_mail_to_author' ] == 1 && !empty($authorEmail) && quoteupAreAuthorEmailsSame($authorEmail)) {
