...
class QuoteupPrivacyTermsCond
{
    ...
    private function __construct()
    {
        ...
        add_action('quoteup_after_product_table_enquiry_mail', array($this, 'addTermsCondTextInEmail'));
    ...
    public function addTermsCondTextInEmail($form_data_for_mail)
    {
        ...
        if ((isset($form_data['term-cond-cc']) && 'yes' === $form_data['term-cond-cc']) || (isset($form_data['terms and conditions']) && 'yes' === $form_data['terms and conditions'])) {
            $tcText = "<br /><br />".sprintf(__('%s accepted the enquiry terms and conditions', QUOTEUP_TEXT_DOMAIN), $form_data['txtemail']);
            ?>
            <p><?php echo $tcText;
            ?></p>
            <?php
