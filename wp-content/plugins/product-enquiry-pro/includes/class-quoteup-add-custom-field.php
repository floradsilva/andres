...
class QuoteUpAddCustomField
{
    ...
    */
    public function __construct()
    {
        ...
        add_action('quoteup_add_custom_field_in_form', array($this, 'addCustomFields'), 10); //done
        add_action('quoteup_add_custom_field_in_db', array($this, 'addCustomFieldsDb'),10, 2); //done
        ...
        add_action('quoteup_add_custom_field_admin_email', array($this, 'addCustomFieldsAdminEmail'), 10, 1);
        add_action('quoteup_add_custom_form_field_in_email', array($this, 'addCustomFormFieldsAdminEmail'), 10, 1);
        add_action('quoteup_add_custom_field_customer_email', array($this, 'addCustomFieldsCustomerEmail'), 10);
    ...
    */
    public function addCustomFormFieldsAdminEmail($data)
    {
        $email = '';
  ...
  * @param array $data Enquiry details
    ...
    */
    public function addCustomFieldsCustomerEmail()
    {
        $email = '';
        foreach ($this->fields as $key => $v) {
