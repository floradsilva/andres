...
class QuoteupHandleQuoteApprovalRejection
{
    ...
    // Approval/Rejection page is not set in the Settings
        ...
        // Check page status and show warning if page's status is Trash
                ...
                $html = '<div class="error">';
                $html .= '<p>';
                $html .= sprintf(__('Page you have set for approval and rejection of quote does not exist. Please set a new page for approval/rejection of quotes  %s here %s.', QUOTEUP_TEXT_DOMAIN), '<a href="admin.php?page=quoteup-for-woocommerce#wdm_approval_rejection_page">', '</a>');
                $html .= '</p>';
                $html .= '</div><!-- /.error -->';
                echo $html;
            }
