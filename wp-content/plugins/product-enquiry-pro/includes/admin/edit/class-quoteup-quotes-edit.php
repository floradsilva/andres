    ...
    */
    public function quotationTable()
    {
        ...
        foreach ($quoteProducts as $singleProduct) {
            ...
            ?>
                            <tr class="wdmpe-detailtbl-content-row <?php echo $deletedClass .' '. $disableCheckBox.' '.$enquiryAnonymizedClass; ?>" data-row-num="<?php echo $count; ?>">
        ...
        <div class="quote-expiration-date">
            ...
            ?>
                <div class='wdm-user-expiration-date'>
                    ...
                    <input type='text' value='<?php echo $quoteup->manageExpiration->getHumanReadableDate($this->enquiry_details['expiration_date']); ?>' class='wdm-input-expiration-date' <?php echo $expirationDisabled ?> readonly  required>
                </div>
                <?php
