                ...
                <table class="version-details" align="center">
                    ...
                    foreach ($versionDetails as $versionDetail) {
                        ...
                        ?>  </p>
                            ...
                            <td class="version-product-qty" data-title="Quantity"><p><?php echo $versionDetail['quantity'];
                        ?></p></td>
                            <td class="version-product-price" data-title="Price"><p><?php echo wc_price($price);
                        ?></p></td>
                        </tr>
                        <?php
