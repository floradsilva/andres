...
<div style='background-color:#ddd'>
    <table class="wdm-enquiry-table" style='width: 100%;background: #F7F7F7;border-bottom: 1px solid #ddd;margin-bottom: 0px;' cellspacing='10px'>
        ...
        if ($source == 'admin' && $optionData['enquiry_form'] != 'custom') {
             ...
             */
            do_action('quoteup_add_custom_field_admin_email', $data_obtained_from_form);
             ...
             */
            do_action('quoteup_add_custom_field_customer_email', $data_obtained_from_form);
        } else {
             ...
             */
            do_action('quoteup_add_custom_form_field_in_email', $data_obtained_from_form);
        }

        do_action('quoteup_before_product_table_enquiry_mail', $form_data_for_mail);
        ?>
    </table>
    <?php
...
do_action('quoteup_after_product_table_enquiry_mail', $form_data_for_mail);
