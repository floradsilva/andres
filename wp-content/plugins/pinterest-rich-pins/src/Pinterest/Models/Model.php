...
use Vsourz\Pinterest\Pinterest\Transport\Response;
...
class Model implements \JsonSerializable {
    ...
    public function __construct(Pinterest $master, $modeldata = null)
    {
        ...
        else if ($modeldata instanceof \Vsourz\Pinterest\Transport\Response) {
	 ...
	 * @ return void
	 */
	public function get_object_vars(array $keys){
		$return = array();
