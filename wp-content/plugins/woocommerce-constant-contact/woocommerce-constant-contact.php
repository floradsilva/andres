 ...
 * Plugin URI: http://www.woocommerce.com/products/woocommerce-constant-contact/
 ...
 *
 * Woo: 216809:0f254fc9658047f5ef543d883c9c7786
...
/**
 * WooCommerce Constant Contact loader.
 *
 * @since 1.10.0
 */
class WC_Constant_Contact_Loader {
	...
	const PLUGIN_NAME = 'WooCommerce Constant Contact';


	/** @var \WC_Constant_Contact_Loader single instance of this class */
	...
	public function init_plugin() {
		...
		if ( $this->plugins_compatible() ) {
			...
			require_once( plugin_dir_path( __FILE__ ) . 'class-wc-constant-contact.php' );
	 ...
	 * @since 1.10.0
	 *
	 * @return \WC_Constant_Contact_Loader
	 */
...
WC_Constant_Contact_Loader::instance();
