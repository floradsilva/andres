...
class WC_Constant_Contact_Frontend {
	...
	/**
	 * Adds a "Subscribe to Newsletter?" checkbox to checkout page.
	 *
	 * @internal
	 *
	 * @since 1.0
	...
	/**
	 * Adds the customer to the email list if they've selected the checkbox
	 *
	 * @internal
	 *
	 * @since 1.0
	...
	/**
	 * Renders a subscribe section on the order received page, if the customer hasn't already subscribed.
	 *
	 * @internal
	 *
	 * @since 1.0
	...
	/**
	 * Processes the AJAX subscribe on the order received page.
	 *
	 * @internal
	 *
	 * @since 1.0
