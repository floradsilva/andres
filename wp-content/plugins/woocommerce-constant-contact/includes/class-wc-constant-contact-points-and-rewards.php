...
class WC_Constant_Contact_Points_and_Rewards {
	...
	/**
	 * Injects the setting for the amount of points a user should earn on registration with Constant Contact.
	 *
	 * @internal
	 *
	 * @since 1.1
	...
	/**
	 * Renders a custom description for points added for an email signup.
	 *
	 * Otherwise the manage table/my points area shows a blank description.
	 *
	 * @internal
	 *
	 * @since 1.1
