...
function boxshop_register_required_plugins(){
    ...
    $plugins = array(
		...
		,array(
            'name'                => 'WooCommerce'
            ,'slug'               => 'woocommerce'
			,'source'             => 'https://downloads.wordpress.org/plugin/woocommerce.3.6.2.zip'
            ,'required'           => true
			,'version'            => '3.6.2'
			,'external_url'       => ''
        )
		...
		,array(
			...
			,'source'             => 'https://downloads.wordpress.org/plugin/mailchimp-for-wp.4.5.1.zip'
            ,'required'           => false
			,'version'            => '4.5.1'
			,'external_url'       => ''
        )
		,array(
			...
			,'source'             => 'https://downloads.wordpress.org/plugin/yith-woocommerce-wishlist.2.2.10.zip'
            ,'required'           => false
			,'version'            => '2.2.10'
			,'external_url'       => ''
        )
		,array(
			...
			,'source'             => 'https://downloads.wordpress.org/plugin/yith-woocommerce-compare.2.3.10.zip'
            ,'required'           => false
			,'version'            => '2.3.10'
			,'external_url'       => ''
        )
