...
foreach ($args['values'] as $v) {
    ...
    if(isset($v['image2'])) $v['image2'] = trx_addons_get_attachment_url($v['image2'], trx_addons_get_thumb_size('skills'));
    $css_image2 = (!empty($v['image2']) ? esc_url($v['image2']) : '');
