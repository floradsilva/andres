...
?>">
	...
	<div class="sc_services_item_info">
		<div class="sc_services_item_header">
			...
			<div class="sc_services_item_subtitle"><?php gravity_show_layout(trx_addons_get_post_terms(', ', get_the_ID(), TRX_ADDONS_CPT_SERVICES_TAXONOMY));?></div>
		</div>
		<?php if (!isset($args['hide_excerpt']) || $args['hide_excerpt']==0) { ?>
			<div class="sc_services_item_content"><?php the_excerpt(); ?></div>
			<div class="sc_services_item_button sc_item_button"><a href="<?php echo esc_url($link); ?>" class="sc_button sc_button_simple"><?php esc_html_e('More info', 'gravity'); ?></a></div>
		<?php } ?>
	</div>
</div>
<?php
